...
The code below will first rename the columns in your data. If you want to change the column names, please also ensure you change the corresponding code. Next, the code will open your files and allow you to select the data you want to process. The data will be stored in the environment as "sensor_data" unless changed.
...
### Load in data
sensor_data <- read_csv(file.choose(), col_names = sensor_col_names)
```
